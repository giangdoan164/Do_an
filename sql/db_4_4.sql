...
insert  into `t_category`(`PK_CATEGORY`,`C_NAME`,`C_DESCRIPTION`) values (1,'Trao đổi chung',NULL),(2,'Góc học tập',NULL),(3,'Góc kỷ luật',NULL),(4,'hohohaha',NULL),(5,'hohohaha','');
...
CREATE TABLE `t_public_post` (
  ...
  `C_CONTENT` text,
  `C_POST_DATE` datetime DEFAULT NULL,
  `C_POSTED_BY` int(11) DEFAULT NULL,
  `C_VIEW` int(11) DEFAULT NULL,
  PRIMARY KEY (`PK_POST`)
...
insert  into `t_public_topic`(`PK_TOPIC`,`FK_CLASS`,`FK_CATEGORY`,`C_TITLE`,`C_POSTED_DATE`,`C_POSTED_BY`) values (1,3,3,'33333333333333333','2015-03-04 00:00:10',39),(2,3,3,'333444444','2015-03-04 00:00:11',39),(3,3,3,'3erer3546363452','2015-02-04 00:00:09',39),(4,3,3,'quefsdfzfzsdf','2015-02-04 00:00:08',39),(5,3,2,'ádasdawdas','2015-02-01 00:00:07',39),(6,3,2,'adsfdsfgdxvxvzsd','2015-02-04 01:01:01',39),(7,3,1,'ádasczxcdfasd','2015-02-04 01:01:05',39),(8,3,3,'dfsdfzfvWESC','2015-02-04 00:01:09',37),(9,3,3,'asdasdwqdasd','2015-02-05 00:00:00',37),(10,3,3,'adasdxd','2015-06-05 00:00:00',37),(11,4,4,'ádasdefDf','2015-06-05 00:00:00',55);

...
insert  into `t_private_message_read_state`(`FK_MESSAGE`,`FK_USER`,`C_READ_DATE`,`C_READ_STATE`) values (19,39,NULL,1),(19,38,NULL,1),(20,38,NULL,1),(20,39,NULL,1),(21,38,NULL,1),(21,39,NULL,1),(22,39,NULL,1),(22,38,NULL,0),(23,36,NULL,1),(23,39,NULL,1),(24,36,NULL,1),(24,39,NULL,0),(25,36,NULL,1),(25,39,NULL,0);
...
insert  into `t_private_thread`(`PK_THREAD`,`C_TITLE`,`C_CREATED_DATE`,`C_CREATED_USER`) values (6,'1111','2015-04-13 21:58:46',39),(7,'222','2015-04-13 22:05:33',38),(8,'1212','2015-04-13 22:27:44',39),(9,'123','2015-04-13 23:10:37',36),(10,'111','2015-04-13 23:40:41',36),(11,'sds','2015-04-13 23:42:56',36);
...
insert  into `t_private_thread_participant`(`FK_THREAD`,`FK_USER`) values (6,38),(7,38),(7,39),(8,39),(8,38),(9,36),(10,36),(10,39),(11,36),(11,39);
...
/*Table structure for table `t_shool_report` */

DROP TABLE IF EXISTS `t_shool_report`;

CREATE TABLE `t_shool_report` (
...
/*Data for the table `t_shool_report` */
